...
function loadProvinsi() {
  fetch("https://toko-kue-production.up.railway.app/api/provinsi")
    .then((res) => res.json())
    .then((data) => {
      let options =
...
function loadKota(provId, el) {
  fetch(`https://toko-kue-production.up.railway.app/api/kota/${provId}`)
    .then((res) => res.json())
    .then((data) => {
      let options =
...
function cekOngkir() {
  ...
  if (asal && tujuan && berat && kurir) {
    fetch(
      `https://toko-kue-production.up.railway.app/api/ongkos/${asal}/${tujuan}/${berat}/${kurir}`
    )
      .then((res) => res.json())
      .then((data) => {
